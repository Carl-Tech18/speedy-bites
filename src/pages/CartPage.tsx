    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 text-center gap-4">
        <motion.div
          ...
          className="w-24 h-24 rounded-3xl bg-accent/15 flex items-center justify-center"
        >
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          ...
          <p className="text-muted-foreground text-sm max-w-xs md:max-w-md mt-2 font-medium">
            Your order from <span className="font-extrabold text-foreground">{restaurant?.name}</span> is being prepared.
        ...
        <motion.div
          ...
          className="bg-card rounded-3xl border-2 border-border/50 p-5 md:p-6 w-full max-w-xs md:max-w-sm shadow-lg shadow-foreground/5"
        >
          <div className="text-sm text-muted-foreground font-medium">Estimated delivery</div>
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4 px-4">
        ...
        <motion.button
          whileTap={{ scale: 0.97 }}
          onClick={() => navigate("/")}
          className="px-8 py-4 bg-primary text-primary-foreground rounded-2xl font-extrabold shadow-lg shadow-primary/25"
        >
          Browse Food 🍕
        </motion.button>
      </div>
          ...
          <div className="md:col-span-2 mt-4 md:mt-0 space-y-4 md:sticky md:top-20">
            ...
            <div className="bg-secondary rounded-3xl p-4 text-center">
              <p className="text-sm text-secondary-foreground font-medium">
                Estimated delivery: <span className="font-extrabold">{restaurant?.deliveryTime[deliveryMode]} minutes</span>
              </p>
            </div>
