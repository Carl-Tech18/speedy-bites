...
const CartPage = () => {
  ...
  if (ordered) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 text-center gap-4">
        ...
        <p className="text-muted-foreground text-sm max-w-xs md:max-w-md">
        ...
        <div className="bg-card rounded-xl border border-border p-4 md:p-6 w-full max-w-xs md:max-w-sm">
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4 px-4">
        ...
        <button onClick={() => navigate("/")} className="px-6 py-3 bg-primary text-primary-foreground rounded-xl font-semibold">
          Browse Food
        </button>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      {/* Header */}
      <div className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b border-border px-4 md:px-6 py-3 flex items-center gap-3">
        ...
        <div className="md:grid md:grid-cols-5 md:gap-6">
          ...
          <div className="md:col-span-2 mt-4 md:mt-0 space-y-4 md:sticky md:top-20">
            ...
            <button
              ...
              className="hidden md:block w-full bg-primary text-primary-foreground font-bold py-4 rounded-2xl text-center shadow-lg hover:opacity-95 transition-opacity"
            >
